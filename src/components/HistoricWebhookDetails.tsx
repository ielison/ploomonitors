...
export default function HistoricWebhookDetails() {
  ...
  // Configuração do gráfico com configuração mais específica para evitar repetição
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Histórico de Webhooks (Detalhes)</h2>
          ...
          {webhookIdsSorted.length > 0 && (
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 transition-colors duration-300">
              ...
              <div className="px-6 py-3 bg-gray-50 dark:bg-gray-700 text-sm text-gray-500 dark:text-gray-400">
                Mostrando {filteredWebhookData.length} de {Math.min(webhookTableData.length, 50)} registros (top 50 por
                volume)
                {selectedWebhookId && (
                  <span className="ml-4">
